"""Tests for ntab_baseline.predict_on_benchmark and ntab_baseline.preprocess_pred_data.
...
from ntab_baseline.constants import (
    FP_SIZE,
    N_MOL_PROP_FEATURES,
    STANDARD_TYPE_INDEX,
)
...
class TestRunInference:
    ...
    def test_returns_ndarray(self) -> None:
        from ntab_baseline.predict_on_benchmark import run_inference
