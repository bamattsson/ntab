...
from timesplit_affinity_benchmark.affinity_utils import (
    add_pchembl_columns,
...
def test_pchembl_value_filled_uses_existing_pchembl_value():
    ...
    df = _make_df([
        {"pchembl_value": 7.5, "standard_value": 100.0, "standard_units": "nM", "standard_relation": "="},
    ])
...
def test_pchembl_value_filled_computes_when_missing():
    ...
    df = _make_df([
        {"pchembl_value": np.nan, "standard_value": 1000.0, "standard_units": "nM", "standard_relation": ">"},
    ])
    out = add_pchembl_columns(df)
...
def test_pchembl_value_filled_stays_nan_for_non_nM():
    df = _make_df([
        {"pchembl_value": np.nan, "standard_value": 1.0, "standard_units": "uM", "standard_relation": ">"},
    ])
    out = add_pchembl_columns(df)
...
def test_pchembl_relation_inverted():
    ...
    df = _make_df([
        {"pchembl_value": np.nan, "standard_value": 1000.0, "standard_units": "nM", "standard_relation": ">"},
        {"pchembl_value": 7.0, "standard_value": None, "standard_units": "nM", "standard_relation": "="},
    ])
    out = add_pchembl_columns(df)
...
def test_add_pchembl_columns_does_not_modify_original():
    df = _make_df([
        {"pchembl_value": np.nan, "standard_value": 100.0, "standard_units": "nM", "standard_relation": ">"},
    ])
...
def test_add_pchembl_columns_preserves_column_order():
    ...
    df = _make_df([
        {"a": 1, "pchembl_value": 7.0, "b": 2, "standard_relation": "=", "c": 3,
         "standard_value": 100.0, "standard_units": "nM"},
    ])
    out = add_pchembl_columns(df)
