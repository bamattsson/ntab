...
from nfab_evaluate.plotting import _parse_split_label, compute_model_stats, load_predictions
...
def _make_merged(n_per_bin: int = 20) -> tuple[pd.DataFrame, list[tuple[float, float, str]]]:
...
def test_compute_model_stats_shape():
    ...
    assert set(stats.columns) == {"display_label", "n_m", "n_a", "pearson_r", "ci_low", "ci_high"}
